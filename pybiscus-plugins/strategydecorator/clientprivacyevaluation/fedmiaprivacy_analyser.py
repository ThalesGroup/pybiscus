...
def get_groundtruth_dataframes(
    ...
    gt_data = []
    for file in os.listdir(f"{data_split_path}"):
        _, client_num, split = file.split("_")
        with open(f"{data_split_path}/{file}", "r") as file:
            for line in file:
...
if __name__ == "__main__":
    ...
    df_cosine, df_loss, cid_list, img_cos_selected, img_loss_selected = get_dataframes(
        round_path="/home/S3G-LABS/u8088/Documents/FederatedLearning/pybiscus/experiments/current/rounds/",
    ...
    df_gt = get_groundtruth_dataframes(
        data_split_path="/home/S3G-LABS/u8088/Documents/FederatedLearning/pybiscus/datasets/cifar10/2clients_splits/",
        save_folder="plots/",
    )
