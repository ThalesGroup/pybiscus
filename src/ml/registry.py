...
def register_from_path(
    ...
    Args:
        base_package: Python package path (e.g. 'src.ml.data')
...
datamodule_registry, DataConfig = register_from_path("src.ml.data", pl.LightningDataModule, True)

#### --- Models ---

model_registry, ModelConfig = register_from_path("src.ml.models", pl.LightningModule, True)
